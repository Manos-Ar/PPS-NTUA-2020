  ...
  //----Find the 4 neighbors with which a process exchanges messages----//
	...
	*/
    ...
    if (rank==0) {
            ...
            #ifdef TEST_CONV
	        printf("RedBlackSOR X %d Y %d Jobs %d Px %d Py %d Iter %d ComputationTime %lf ConvergedTime %lf TotalTime %lf midpoint %lf\n",global[0],global[1],size,grid[0],grid[1],t,comp_time,conv_time,total_time,U[global[0]/2][global[1]/2]);
		    #endif
		    #ifndef TEST_CONV
	        printf("RedBlackSOR X %d Y %d Jobs %d Px %d Py %d Iter %d ComputationTime %lf TotalTime %lf midpoint %lf\n",global[0],global[1],size,grid[0],grid[1],t,comp_time,total_time,U[global[0]/2][global[1]/2]);
		    #endif
